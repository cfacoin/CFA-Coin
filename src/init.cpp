...
{
    uiInterface.ThreadSafeMessageBox(str, _("CFACoin"), CClientUIInterface::BTN_OK | CClientUIInterface::MODAL);
    return false;
}

bool static InitWarning(const std::string &str)
{
    uiInterface.ThreadSafeMessageBox(str, _("CFACoin"), CClientUIInterface::BTN_OK | CClientUIInterface::ICON_WARNING | CClientUIInterface::MODAL);
    return true;
}
...
std::string HelpMessage()
{
    std::string strUsage = _("Options:") + "\n";
        ...
        strUsage += "  -conf=<file>           " + _("Specify configuration file (default: cfacoin.conf)") + "\n";
        strUsage += "  -pid=<file>            " + _("Specify pid file (default: cfacoind.pid)") + "\n";
        ...
        strUsage += "  -port=<port>           " + _("Listen for connections on <port> (default: 49901 or testnet: 49903)") + "\n";
        ...
        strUsage += "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 49902 or testnet: 49904)") + "\n";
    ...
    ********************************************************* */
    ...
    if (fs::exists(GetDataDir() / strWalletFileName))
    {
        ...
        if (r == CDBEnv::RECOVER_OK)
        {
            ...
            uiInterface.ThreadSafeMessageBox(msg, _("CFACoin"), CClientUIInterface::BTN_OK | CClientUIInterface::ICON_WARNING | CClientUIInterface::MODAL);
        };
