...
/**
  CFACoin GUI main class. This class represents the main window of the CFACoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class CFACoinGUI : public QMainWindow
{
    Q_OBJECT
public:
    explicit CFACoinGUI(QWidget *parent = 0);
    ~CFACoinGUI();
