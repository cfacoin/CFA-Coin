#ifndef CFACOINBRIDGE_H
#define CFACOINBRIDGE_H
...
class CFACoinBridge : public QObject
{
    Q_OBJECT
...
public:
    explicit CFACoinBridge(CFACoinGUI *window, QObject *parent = 0);
    ~CFACoinBridge();
