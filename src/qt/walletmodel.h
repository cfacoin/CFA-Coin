...
public:
    ...
    enum StatusCode // Returned by sendCoins
    {
        ...
        SCR_AmountWithFeeExceedsCFACoinBalance,
        SCR_Error,
        SCR_ErrorWithMsg,
        Aborted
    };
    ...
    qint64 getCFACoinBalance() const;
...
signals:
    ...
    void balanceChanged(qint64 balance, qint64 cfacoinBal, qint64 stake, qint64 unconfirmedBalance, qint64 immatureBalance);
