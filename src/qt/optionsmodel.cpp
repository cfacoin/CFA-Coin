...
void OptionsModel::Init()
{
    ...
    nDisplayUnit = settings.value("nDisplayUnit", BitcoinUnits::CFA).toInt();
    ...
    fAutoRedeemCFACoin = settings.value("fAutoRedeemCFACoin", false).toBool();
...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        case AutoRedeemCFACoin:
            return fAutoRedeemCFACoin;
        case MinRingSize:
            return nMinRingSize;
        case MaxRingSize:
            return nMaxRingSize;
...
QString OptionsModel::optionIDName(int row)
{
    ...
    case AutoRedeemCFACoin: return "AutoRedeemCFACoin";
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DisplayAddresses:
            ...
            emit displayUnitChanged(settings.value("nDisplayUnit", BitcoinUnits::CFA).toInt());
            break;
        case DetachDatabases: {
        ...
        case AutoRingSize: {
            ...
            break;
        case AutoRedeemCFACoin: {
            fAutoRedeemCFACoin = value.toBool();
            settings.setValue("fAutoRedeemCFACoin", fAutoRedeemCFACoin);
            }
            break;
        case MinRingSize: {
...
bool OptionsModel::getAutoRedeemCFACoin() { return fAutoRedeemCFACoin; }
