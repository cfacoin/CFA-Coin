...
DEFINES += BOOST_THREAD_USE_LIB BOOST_SPIRIT_THREADSAFE #HAVE_WORKING_BOOST_SLEEP_FOR
...
contains(CFACOIN_NEED_QT_PLUGINS, 1) {
    DEFINES += CFACOIN_NEED_QT_PLUGINS
...
SOURCES += \
    ...
    src/qt/cfacoingui.cpp \
    src/qt/cfacoin.cpp \
    src/qt/cfacoinbridge.cpp \
...
macx:ICON = src/qt/res/icons/cfacoin.icns
macx:TARGET = "CFACoin"
